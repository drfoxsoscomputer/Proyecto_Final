    ...
    <section className="w-[100%] flex flex-col items-center justify-center text-center">
      <section className="relative flex w-full h-[90vh] items-center justify-center bg-[url('/src/views/Landing/all_games.jpg')] bg-cover bg-center">
        ...
        <div
          ...
          <h1 className="text-3xl sm:text-7xl font-bold text-white">LA TIENDA DE GAMERS PARA GAMERS</h1>
          <p className="text-base sm:text-xl max-w-xs text-white">compra juegos digitales y fisicos al mejor precio del mercado</p>
          <div className="w-[250px] sm:w-[420px] flex items-center justify-between">
            <Link to="/join">
              <button className="w-[120px] h-[35px] sm:w-[190px] sm:h-[50px] bg-gradient-to-r from-violet-600 to-orange-600 text-white text-base sm:text-xl">Join now</button>
            </Link>
            <Link to="/home">
              <button className="w-[120px] h-[35px] sm:w-[190px] sm:h-[50px] border-[#8f00ff] border-2 text-white text-base sm:text-xl">Home</button>
            </Link>
          </div>
        </div>
      </section>
      <section
        ...
        <div className="flex items-center justify-evenly gap-8 flex-col overflow-hidden h-full">
          <h1 className="text-2xl sm:text-5xl font-bold">ACCEDE A +1000 JUEGOS</h1>
      ...
      <section
        ...
        <div className="flex items-start h-full gap-8 flex-col col-start-1 col-end-2 row-start-3 row-end-4 text-left">
          <h1 className="text-5xl font-bold w-[50%]">EN FORMATO FISICO Y/O DIGITAL</h1>
        </div>
        <img
          data-aos="fade-left"
          data-aos-duration="2000"
      ...
      <section
        ...
        <div className="flex items-center gap-8 flex-col mt-[50px] z-10">
          <h1 className="text-3xl sm:text-7xl font-bold text-white">SE PARTE DE LA COMUNIDAD</h1>
      ...
      <section className="text-gray-400 bg-gray-900 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Equipo Developer</h1>
          ...
          <div className="flex flex-wrap -m-2">
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Antonio Ricardo Rodriguez Gramajo</h2>
            ...
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                ...
                />
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Denis Alexander Piña Rodriguez</h2>
            ...
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                ...
                />
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Eduardo Alejandro Mario Abrego</h2>
                  <p className="text-gray-600">Argentina</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                ...
                />
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Eduardo Lautaro Bunkowski</h2>
                  <p className="text-gray-600">Argentina</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                ...
                />
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Jhoan Alexander Franco Murcia</h2>
            ...
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                ...
                />
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Victor javier Del Castillo Holguin</h2>
            ...
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-gray-800 border p-4 rounded-lg">
                ...
                />
                <div className="flex-grow">
                  <h2 className="text-white title-font font-medium">Vladimir Esquivel Andrade</h2>
                  <p className="text-gray-600">Colombia</p>
                </div>
              </div>
            </div>
